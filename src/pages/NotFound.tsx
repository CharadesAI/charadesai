    ...
    <div className='relative flex min-h-screen items-center justify-center bg-gradient-hero overflow-hidden'>
      ...
      <div className='glass max-w-2xl w-full p-10 rounded-3xl shadow-lg mx-4'>
        <div className='text-center'>
          <div className='mb-6'>
            <span className='inline-block text-7xl md:text-8xl lg:text-9xl font-extrabold text-gradient drop-shadow-lg'>
              404
            </span>
          </div>
          <h1 className='text-2xl md:text-3xl lg:text-4xl font-semibold mb-3 text-foreground'>
            Page Not Found
          </h1>
